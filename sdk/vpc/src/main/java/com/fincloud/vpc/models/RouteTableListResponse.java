...
/**
 * The RouteTableListResponse model.
 */
public class RouteTableListResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the RouteTableListResponse object itself.
     */
    public RouteTableListResponse withReturnCode(String returnCode) {
     ...
     * @return the RouteTableListResponse object itself.
     */
    public RouteTableListResponse withReturnMessage(String returnMessage) {
     ...
     * @return the RouteTableListResponse object itself.
     */
    public RouteTableListResponse withTotalRows(Integer totalRows) {
     ...
     * @return the RouteTableListResponse object itself.
     */
    public RouteTableListResponse withRouteTableList(List<RouteTableList> routeTableList) {
