...
/**
 * The VpcPeeringResponse model.
 */
public class VpcPeeringResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the VpcPeeringResponse object itself.
     */
    public VpcPeeringResponse withReturnCode(String returnCode) {
     ...
     * @return the VpcPeeringResponse object itself.
     */
    public VpcPeeringResponse withReturnMessage(String returnMessage) {
     ...
     * @return the VpcPeeringResponse object itself.
     */
    public VpcPeeringResponse withTotalRows(Integer totalRows) {
     ...
     * @return the VpcPeeringResponse object itself.
     */
    public VpcPeeringResponse withVpcPeeringInstanceList(List<VpcPeeringInstanceList> vpcPeeringInstanceList) {
