...
public class NetworkAclResponse {
     ...
     * @return the NetworkAclResponse object itself.
     */
    public NetworkAclResponse withReturnCode(String returnCode) {
     ...
     * @return the NetworkAclResponse object itself.
     */
    public NetworkAclResponse withReturnMessage(String returnMessage) {
     ...
     * @return the NetworkAclResponse object itself.
     */
    public NetworkAclResponse withTotalRows(Integer totalRows) {
     ...
     * @return the NetworkAclResponse object itself.
     */
    public NetworkAclResponse withNetworkAclList(List<NetworkAclList> networkAclList) {
