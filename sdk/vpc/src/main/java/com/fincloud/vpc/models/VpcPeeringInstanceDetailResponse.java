...
/**
 * The VpcPeeringInstanceDetailResponse model.
 */
public class VpcPeeringInstanceDetailResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the VpcPeeringInstanceDetailResponse object itself.
     */
    public VpcPeeringInstanceDetailResponse withReturnCode(String returnCode) {
     ...
     * @return the VpcPeeringInstanceDetailResponse object itself.
     */
    public VpcPeeringInstanceDetailResponse withReturnMessage(String returnMessage) {
     ...
     * @return the VpcPeeringInstanceDetailResponse object itself.
     */
    public VpcPeeringInstanceDetailResponse withTotalRows(Integer totalRows) {
     ...
     * @return the VpcPeeringInstanceDetailResponse object itself.
     */
    public VpcPeeringInstanceDetailResponse withVpcPeeringInstanceList(List<VpcPeeringInstanceList> vpcPeeringInstanceList) {
