...
/**
 * The RouteTableSubnetListResponse model.
 */
public class RouteTableSubnetListResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the RouteTableSubnetListResponse object itself.
     */
    public RouteTableSubnetListResponse withReturnCode(String returnCode) {
     ...
     * @return the RouteTableSubnetListResponse object itself.
     */
    public RouteTableSubnetListResponse withReturnMessage(String returnMessage) {
     ...
     * @return the RouteTableSubnetListResponse object itself.
     */
    public RouteTableSubnetListResponse withTotalRows(Integer totalRows) {
     ...
     * @return the RouteTableSubnetListResponse object itself.
     */
    public RouteTableSubnetListResponse withSubnetList(List<SubnetList> subnetList) {
