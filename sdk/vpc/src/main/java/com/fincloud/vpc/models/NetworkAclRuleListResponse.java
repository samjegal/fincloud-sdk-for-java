...
/**
 * The NetworkAclRuleListResponse model.
 */
public class NetworkAclRuleListResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the NetworkAclRuleListResponse object itself.
     */
    public NetworkAclRuleListResponse withReturnCode(String returnCode) {
     ...
     * @return the NetworkAclRuleListResponse object itself.
     */
    public NetworkAclRuleListResponse withReturnMessage(String returnMessage) {
     ...
     * @return the NetworkAclRuleListResponse object itself.
     */
    public NetworkAclRuleListResponse withTotalRows(Integer totalRows) {
     ...
     * @return the NetworkAclRuleListResponse object itself.
     */
    public NetworkAclRuleListResponse withNetworkAclRuleList(List<NetworkAclRuleList> networkAclRuleList) {
