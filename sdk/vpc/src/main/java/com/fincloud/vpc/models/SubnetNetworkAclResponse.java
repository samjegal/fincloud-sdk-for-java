...
/**
 * The SubnetNetworkAclResponse model.
 */
public class SubnetNetworkAclResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the SubnetNetworkAclResponse object itself.
     */
    public SubnetNetworkAclResponse withReturnCode(String returnCode) {
     ...
     * @return the SubnetNetworkAclResponse object itself.
     */
    public SubnetNetworkAclResponse withReturnMessage(String returnMessage) {
     ...
     * @return the SubnetNetworkAclResponse object itself.
     */
    public SubnetNetworkAclResponse withTotalRows(Integer totalRows) {
     ...
     * @return the SubnetNetworkAclResponse object itself.
     */
    public SubnetNetworkAclResponse withNetworkAclList(List<NetworkAclList> networkAclList) {
