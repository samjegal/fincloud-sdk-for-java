...
/**
 * The NatGatewayInstanceDetailResponse model.
 */
public class NatGatewayInstanceDetailResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the NatGatewayInstanceDetailResponse object itself.
     */
    public NatGatewayInstanceDetailResponse withReturnCode(String returnCode) {
     ...
     * @return the NatGatewayInstanceDetailResponse object itself.
     */
    public NatGatewayInstanceDetailResponse withReturnMessage(String returnMessage) {
     ...
     * @return the NatGatewayInstanceDetailResponse object itself.
     */
    public NatGatewayInstanceDetailResponse withTotalRows(Integer totalRows) {
     ...
     * @return the NatGatewayInstanceDetailResponse object itself.
     */
    public NatGatewayInstanceDetailResponse withNatGatewayInstanceList(List<NatGatewayInstanceList> natGatewayInstanceList) {
