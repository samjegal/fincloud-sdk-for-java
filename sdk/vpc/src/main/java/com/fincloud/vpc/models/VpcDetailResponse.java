...
/**
 * The VpcDetailResponse model.
 */
public class VpcDetailResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the VpcDetailResponse object itself.
     */
    public VpcDetailResponse withReturnCode(String returnCode) {
     ...
     * @return the VpcDetailResponse object itself.
     */
    public VpcDetailResponse withReturnMessage(String returnMessage) {
     ...
     * @return the VpcDetailResponse object itself.
     */
    public VpcDetailResponse withTotalRows(Integer totalRows) {
     ...
     * @return the VpcDetailResponse object itself.
     */
    public VpcDetailResponse withVpcList(List<VpcList> vpcList) {
