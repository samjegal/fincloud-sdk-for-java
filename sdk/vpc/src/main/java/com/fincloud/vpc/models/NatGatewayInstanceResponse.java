...
/**
 * The NatGatewayInstanceResponse model.
 */
public class NatGatewayInstanceResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the NatGatewayInstanceResponse object itself.
     */
    public NatGatewayInstanceResponse withReturnCode(String returnCode) {
     ...
     * @return the NatGatewayInstanceResponse object itself.
     */
    public NatGatewayInstanceResponse withReturnMessage(String returnMessage) {
     ...
     * @return the NatGatewayInstanceResponse object itself.
     */
    public NatGatewayInstanceResponse withTotalRows(Integer totalRows) {
     ...
     * @return the NatGatewayInstanceResponse object itself.
     */
    public NatGatewayInstanceResponse withNatGatewayInstanceList(List<NatGatewayInstanceList> natGatewayInstanceList) {
