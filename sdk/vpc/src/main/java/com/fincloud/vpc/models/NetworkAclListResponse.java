...
/**
 * The NetworkAclListResponse model.
 */
public class NetworkAclListResponse {
     ...
     * @return the NetworkAclListResponse object itself.
     */
    public NetworkAclListResponse withReturnCode(String returnCode) {
     ...
     * @return the NetworkAclListResponse object itself.
     */
    public NetworkAclListResponse withReturnMessage(String returnMessage) {
     ...
     * @return the NetworkAclListResponse object itself.
     */
    public NetworkAclListResponse withTotalRows(Integer totalRows) {
     ...
     * @return the NetworkAclListResponse object itself.
     */
    public NetworkAclListResponse withNetworkAclList(List<NetworkAclList> networkAclList) {
