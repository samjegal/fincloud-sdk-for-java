...
/**
 * The VpcPeeringInstanceResponse model.
 */
public class VpcPeeringInstanceResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the VpcPeeringInstanceResponse object itself.
     */
    public VpcPeeringInstanceResponse withReturnCode(String returnCode) {
     ...
     * @return the VpcPeeringInstanceResponse object itself.
     */
    public VpcPeeringInstanceResponse withReturnMessage(String returnMessage) {
     ...
     * @return the VpcPeeringInstanceResponse object itself.
     */
    public VpcPeeringInstanceResponse withTotalRows(Integer totalRows) {
     ...
     * @return the VpcPeeringInstanceResponse object itself.
     */
    public VpcPeeringInstanceResponse withVpcPeeringInstanceList(List<VpcPeeringInstanceList> vpcPeeringInstanceList) {
