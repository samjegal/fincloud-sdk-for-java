...
public class SubnetResponse {
     ...
     * @return the SubnetResponse object itself.
     */
    public SubnetResponse withReturnCode(String returnCode) {
     ...
     * @return the SubnetResponse object itself.
     */
    public SubnetResponse withReturnMessage(String returnMessage) {
     ...
     * @return the SubnetResponse object itself.
     */
    public SubnetResponse withTotalRows(Integer totalRows) {
     ...
     * @return the SubnetResponse object itself.
     */
    public SubnetResponse withSubnetList(List<SubnetList> subnetList) {
