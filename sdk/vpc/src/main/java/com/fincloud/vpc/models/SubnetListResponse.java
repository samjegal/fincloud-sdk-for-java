...
public class SubnetListResponse {
     ...
     * @return the SubnetListResponse object itself.
     */
    public SubnetListResponse withReturnCode(String returnCode) {
     ...
     * @return the SubnetListResponse object itself.
     */
    public SubnetListResponse withReturnMessage(String returnMessage) {
     ...
     * @return the SubnetListResponse object itself.
     */
    public SubnetListResponse withTotalRows(Integer totalRows) {
     ...
     * @return the SubnetListResponse object itself.
     */
    public SubnetListResponse withSubnetList(List<SubnetList> subnetList) {
