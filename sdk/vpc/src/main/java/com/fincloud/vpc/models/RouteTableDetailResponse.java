...
/**
 * The RouteTableDetailResponse model.
 */
public class RouteTableDetailResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the RouteTableDetailResponse object itself.
     */
    public RouteTableDetailResponse withReturnCode(String returnCode) {
     ...
     * @return the RouteTableDetailResponse object itself.
     */
    public RouteTableDetailResponse withReturnMessage(String returnMessage) {
     ...
     * @return the RouteTableDetailResponse object itself.
     */
    public RouteTableDetailResponse withTotalRows(Integer totalRows) {
     ...
     * @return the RouteTableDetailResponse object itself.
     */
    public RouteTableDetailResponse withRouteTableList(List<RouteTableList> routeTableList) {
