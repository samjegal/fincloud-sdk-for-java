...
/**
 * The RouteTableSubnetResponse model.
 */
public class RouteTableSubnetResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the RouteTableSubnetResponse object itself.
     */
    public RouteTableSubnetResponse withReturnCode(String returnCode) {
     ...
     * @return the RouteTableSubnetResponse object itself.
     */
    public RouteTableSubnetResponse withReturnMessage(String returnMessage) {
     ...
     * @return the RouteTableSubnetResponse object itself.
     */
    public RouteTableSubnetResponse withTotalRows(Integer totalRows) {
     ...
     * @return the RouteTableSubnetResponse object itself.
     */
    public RouteTableSubnetResponse withSubnetList(List<SubnetList> subnetList) {
