...
public class ImageTagResultItem {
     ...
     * @return the ImageTagResultItem object itself.
     */
    public ImageTagResultItem withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ImageTagResultItem object itself.
     */
    public ImageTagResultItem withFullSize(Double fullSize) {
     ...
     * @return the ImageTagResultItem object itself.
     */
    public ImageTagResultItem withImages(List<ImageTagResultImagesItem> images) {
        this.images = images;
        return this;
    }
     ...
     * @return the ImageTagResultItem object itself.
     */
    public ImageTagResultItem withId(Double id) {
        this.id = id;
        return this;
    }
     ...
     * @return the ImageTagResultItem object itself.
     */
    public ImageTagResultItem withRepository(Double repository) {
     ...
     * @return the ImageTagResultItem object itself.
     */
    public ImageTagResultItem withCreator(String creator) {
     ...
     * @return the ImageTagResultItem object itself.
     */
    public ImageTagResultItem withLastUpdater(String lastUpdater) {
     ...
     * @return the ImageTagResultItem object itself.
     */
    public ImageTagResultItem withLastUpdated(Double lastUpdated) {
     ...
     * @return the ImageTagResultItem object itself.
     */
    public ImageTagResultItem withImageId(Double imageId) {
     ...
     * @return the ImageTagResultItem object itself.
     */
    public ImageTagResultItem withV2(Boolean v2) {
        this.v2 = v2;
        return this;
    }
