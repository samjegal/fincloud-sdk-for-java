...
/**
 * The NasVolumeSizeResponse model.
 */
public class NasVolumeSizeResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the NasVolumeSizeResponse object itself.
     */
    public NasVolumeSizeResponse withReturnCode(String returnCode) {
     ...
     * @return the NasVolumeSizeResponse object itself.
     */
    public NasVolumeSizeResponse withReturnMessage(String returnMessage) {
     ...
     * @return the NasVolumeSizeResponse object itself.
     */
    public NasVolumeSizeResponse withTotalRows(Integer totalRows) {
     ...
     * @return the NasVolumeSizeResponse object itself.
     */
    public NasVolumeSizeResponse withNasVolumeInstanceList(List<NasVolumeInstanceList> nasVolumeInstanceList) {
