...
/**
 * The NasVolumeAccessControlResponse model.
 */
public class NasVolumeAccessControlResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the NasVolumeAccessControlResponse object itself.
     */
    public NasVolumeAccessControlResponse withReturnCode(String returnCode) {
     ...
     * @return the NasVolumeAccessControlResponse object itself.
     */
    public NasVolumeAccessControlResponse withReturnMessage(String returnMessage) {
     ...
     * @return the NasVolumeAccessControlResponse object itself.
     */
    public NasVolumeAccessControlResponse withTotalRows(Integer totalRows) {
     ...
     * @return the NasVolumeAccessControlResponse object itself.
     */
    public NasVolumeAccessControlResponse withNasVolumeInstanceList(List<NasVolumeInstanceList> nasVolumeInstanceList) {
