...
/**
 * The NasVolumeInstanceDetailResponse model.
 */
public class NasVolumeInstanceDetailResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the NasVolumeInstanceDetailResponse object itself.
     */
    public NasVolumeInstanceDetailResponse withReturnCode(String returnCode) {
     ...
     * @return the NasVolumeInstanceDetailResponse object itself.
     */
    public NasVolumeInstanceDetailResponse withReturnMessage(String returnMessage) {
     ...
     * @return the NasVolumeInstanceDetailResponse object itself.
     */
    public NasVolumeInstanceDetailResponse withTotalRows(Integer totalRows) {
     ...
     * @return the NasVolumeInstanceDetailResponse object itself.
     */
    public NasVolumeInstanceDetailResponse withNasVolumeInstanceList(List<NasVolumeInstanceList> nasVolumeInstanceList) {
