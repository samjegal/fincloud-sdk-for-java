...
/**
 * The NasVolumeInstancesResponse model.
 */
public class NasVolumeInstancesResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the NasVolumeInstancesResponse object itself.
     */
    public NasVolumeInstancesResponse withReturnCode(String returnCode) {
     ...
     * @return the NasVolumeInstancesResponse object itself.
     */
    public NasVolumeInstancesResponse withReturnMessage(String returnMessage) {
     ...
     * @return the NasVolumeInstancesResponse object itself.
     */
    public NasVolumeInstancesResponse withTotalRows(Integer totalRows) {
     ...
     * @return the NasVolumeInstancesResponse object itself.
     */
    public NasVolumeInstancesResponse withNasVolumeInstanceList(List<NasVolumeInstanceList> nasVolumeInstanceList) {
