...
/**
 * The FilePluginRequest model.
 */
public class FilePluginRequest {
    /**
     * 파일 리스트.
     */
     ...
     * @return the FilePluginRequest object itself.
     */
    public FilePluginRequest withConfigList(List<String> configList) {
     ...
     * @return the FilePluginRequest object itself.
     */
    public FilePluginRequest withInstanceNo(String instanceNo) {
