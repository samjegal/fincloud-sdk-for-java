...
/**
 * The MultipleDataParameter model.
 */
public class MultipleDataParameter {
    /**
    ...
    private DimensionResultParameter dimensions;
     ...
     * @return the MultipleDataParameter object itself.
     */
    public MultipleDataParameter withAggregation(AggregationType aggregation) {
     ...
     */
    public DimensionResultParameter dimensions() {
     ...
     * @return the MultipleDataParameter object itself.
     */
    public MultipleDataParameter withDimensions(DimensionResultParameter dimensions) {
     ...
     * @return the MultipleDataParameter object itself.
     */
    public MultipleDataParameter withDps(List<List<Double>> dps) {
        this.dps = dps;
        return this;
    }
     ...
     * @return the MultipleDataParameter object itself.
     */
    public MultipleDataParameter withInterval(QueryIntervalTime interval) {
     ...
     * @return the MultipleDataParameter object itself.
     */
    public MultipleDataParameter withMetric(String metric) {
        this.metric = metric;
        return this;
    }
     ...
     * @return the MultipleDataParameter object itself.
     */
    public MultipleDataParameter withProductName(String productName) {
