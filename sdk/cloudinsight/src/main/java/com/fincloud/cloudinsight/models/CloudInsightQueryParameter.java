...
/**
 * The CloudInsightQueryParameter model.
 */
public class CloudInsightQueryParameter {
    /**
     * 마지막 조회 시간.
     */
     ...
     * @return the CloudInsightQueryParameter object itself.
     */
    public CloudInsightQueryParameter withTimeEnd(Double timeEnd) {
     ...
     * @return the CloudInsightQueryParameter object itself.
     */
    public CloudInsightQueryParameter withTimeStart(Double timeStart) {
     ...
     * @return the CloudInsightQueryParameter object itself.
     */
    public CloudInsightQueryParameter withMetric(String metric) {
        this.metric = metric;
        return this;
    }
     ...
     * @return the CloudInsightQueryParameter object itself.
     */
    public CloudInsightQueryParameter withInterval(QueryIntervalTime interval) {
     ...
     * @return the CloudInsightQueryParameter object itself.
     */
    public CloudInsightQueryParameter withAggregation(AggregationType aggregation) {
     ...
     * @return the CloudInsightQueryParameter object itself.
     */
    public CloudInsightQueryParameter withQueryAggregation(QueryAggregationType queryAggregation) {
     ...
     * @return the CloudInsightQueryParameter object itself.
     */
    public CloudInsightQueryParameter withCwKey(String cwKey) {
        this.cwKey = cwKey;
        return this;
    }
     ...
     * @return the CloudInsightQueryParameter object itself.
     */
    public CloudInsightQueryParameter withProductName(String productName) {
     ...
     * @return the CloudInsightQueryParameter object itself.
     */
    public CloudInsightQueryParameter withDimensions(CloudInsightDimensionParameter dimensions) {
