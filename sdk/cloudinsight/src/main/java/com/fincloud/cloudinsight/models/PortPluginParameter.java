...
/**
 * The PortPluginParameter model.
 */
public class PortPluginParameter {
    /**
     * 포트 번호 리스트.
     */
     ...
     * @return the PortPluginParameter object itself.
     */
    public PortPluginParameter withConfigList(List<Integer> configList) {
     ...
     * @return the PortPluginParameter object itself.
     */
    public PortPluginParameter withInstanceNo(String instanceNo) {
