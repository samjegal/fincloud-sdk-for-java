...
/**
 * The PortPluginRequest model.
 */
public class PortPluginRequest {
    /**
     * 포트 번호 리스트.
     */
     ...
     * @return the PortPluginRequest object itself.
     */
    public PortPluginRequest withConfigList(List<Integer> configList) {
     ...
     * @return the PortPluginRequest object itself.
     */
    public PortPluginRequest withInstanceNo(String instanceNo) {
