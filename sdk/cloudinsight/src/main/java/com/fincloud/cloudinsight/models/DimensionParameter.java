...
public class DimensionParameter {
     ...
     * @return the DimensionParameter object itself.
     */
    public DimensionParameter withType(DimensionType type) {
        this.type = type;
        return this;
    }
     ...
     * @return the DimensionParameter object itself.
     */
    public DimensionParameter withInstanceNo(String instanceNo) {
     ...
     * @return the DimensionParameter object itself.
     */
    public DimensionParameter withCpuIdx(Integer cpuIdx) {
        this.cpuIdx = cpuIdx;
        return this;
    }
     ...
     * @return the DimensionParameter object itself.
     */
    public DimensionParameter withDiskIdx(String diskIdx) {
     ...
     * @return the DimensionParameter object itself.
     */
    public DimensionParameter withMntNm(String mntNm) {
        this.mntNm = mntNm;
        return this;
    }
     ...
     * @return the DimensionParameter object itself.
     */
    public DimensionParameter withNicDesc(String nicDesc) {
     ...
     * @return the DimensionParameter object itself.
     */
    public DimensionParameter withProcName(String procName) {
     ...
     * @return the DimensionParameter object itself.
     */
    public DimensionParameter withPath(String path) {
        this.path = path;
        return this;
    }
     ...
     * @return the DimensionParameter object itself.
     */
    public DimensionParameter withPort(Integer port) {
        this.port = port;
        return this;
    }
     ...
     * @return the DimensionParameter object itself.
     */
    public DimensionParameter withLoadBalancerAddress(String loadBalancerAddress) {
     ...
     * @return the DimensionParameter object itself.
     */
    public DimensionParameter withLoadBalancerPort(String loadBalancerPort) {
     ...
     * @return the DimensionParameter object itself.
     */
    public DimensionParameter withInstanceId(String instanceId) {
     ...
     * @return the DimensionParameter object itself.
     */
    public DimensionParameter withLoadBalancerName(String loadBalancerName) {
     ...
     * @return the DimensionParameter object itself.
     */
    public DimensionParameter withNetworkType(String networkType) {
     ...
     * @return the DimensionParameter object itself.
     */
    public DimensionParameter withLayerType(String layerType) {
     ...
     * @return the DimensionParameter object itself.
     */
    public DimensionParameter withAutoScalingGroupNo(Integer autoScalingGroupNo) {
