...
public class NesDateTime {
     ...
     * @return the NesDateTime object itself.
     */
    public NesDateTime withUtc(Long utc) {
        this.utc = utc;
        return this;
    }
     ...
     * @return the NesDateTime object itself.
     */
    public NesDateTime withFormattedDate(String formattedDate) {
     ...
     * @return the NesDateTime object itself.
     */
    public NesDateTime withFormattedDateTime(String formattedDateTime) {
