...
public class EmailResponseEmailStatus {
     ...
     * @return the EmailResponseEmailStatus object itself.
     */
    public EmailResponseEmailStatus withLabel(String label) {
        this.label = label;
        return this;
    }
     ...
     * @return the EmailResponseEmailStatus object itself.
     */
    public EmailResponseEmailStatus withCode(String code) {
        this.code = code;
        return this;
    }
