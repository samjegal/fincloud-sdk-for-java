...
/**
 * The EmailSendListResponseSortItem model.
 */
public class EmailSendListResponseSortItem {
    /**
     * 정렬 방향 (ASC|DESC).
     */
     ...
     * @return the EmailSendListResponseSortItem object itself.
     */
    public EmailSendListResponseSortItem withDirection(String direction) {
     ...
     * @return the EmailSendListResponseSortItem object itself.
     */
    public EmailSendListResponseSortItem withProperty(String property) {
     ...
     * @return the EmailSendListResponseSortItem object itself.
     */
    public EmailSendListResponseSortItem withIgnoreCase(Boolean ignoreCase) {
     ...
     * @return the EmailSendListResponseSortItem object itself.
     */
    public EmailSendListResponseSortItem withNullHandling(String nullHandling) {
     ...
     * @return the EmailSendListResponseSortItem object itself.
     */
    public EmailSendListResponseSortItem withAscending(Boolean ascending) {
     ...
     * @return the EmailSendListResponseSortItem object itself.
     */
    public EmailSendListResponseSortItem withDescending(Boolean descending) {
