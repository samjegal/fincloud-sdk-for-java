...
/**
 * The UnsubscribeListResponseSortItem model.
 */
public class UnsubscribeListResponseSortItem {
    /**
     * 정렬 방향 (ASC|DESC).
     */
     ...
     * @return the UnsubscribeListResponseSortItem object itself.
     */
    public UnsubscribeListResponseSortItem withDirection(String direction) {
     ...
     * @return the UnsubscribeListResponseSortItem object itself.
     */
    public UnsubscribeListResponseSortItem withProperty(String property) {
     ...
     * @return the UnsubscribeListResponseSortItem object itself.
     */
    public UnsubscribeListResponseSortItem withIgnoreCase(Boolean ignoreCase) {
     ...
     * @return the UnsubscribeListResponseSortItem object itself.
     */
    public UnsubscribeListResponseSortItem withNullHandling(String nullHandling) {
     ...
     * @return the UnsubscribeListResponseSortItem object itself.
     */
    public UnsubscribeListResponseSortItem withAscending(Boolean ascending) {
     ...
     * @return the UnsubscribeListResponseSortItem object itself.
     */
    public UnsubscribeListResponseSortItem withDescending(Boolean descending) {
