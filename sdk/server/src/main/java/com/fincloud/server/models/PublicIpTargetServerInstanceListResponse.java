...
/**
 * The PublicIpTargetServerInstanceListResponse model.
 */
public class PublicIpTargetServerInstanceListResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the PublicIpTargetServerInstanceListResponse object itself.
     */
    public PublicIpTargetServerInstanceListResponse withReturnCode(String returnCode) {
     ...
     * @return the PublicIpTargetServerInstanceListResponse object itself.
     */
    public PublicIpTargetServerInstanceListResponse withReturnMessage(String returnMessage) {
     ...
     * @return the PublicIpTargetServerInstanceListResponse object itself.
     */
    public PublicIpTargetServerInstanceListResponse withTotalRows(Integer totalRows) {
     ...
     * @return the PublicIpTargetServerInstanceListResponse object itself.
     */
    public PublicIpTargetServerInstanceListResponse withServerInstanceList(List<ServerInstanceList> serverInstanceList) {
