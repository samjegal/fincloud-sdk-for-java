...
/**
 * The ServerInstanceDetailResponse model.
 */
public class ServerInstanceDetailResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the ServerInstanceDetailResponse object itself.
     */
    public ServerInstanceDetailResponse withReturnCode(String returnCode) {
     ...
     * @return the ServerInstanceDetailResponse object itself.
     */
    public ServerInstanceDetailResponse withReturnMessage(String returnMessage) {
     ...
     * @return the ServerInstanceDetailResponse object itself.
     */
    public ServerInstanceDetailResponse withTotalRows(Integer totalRows) {
     ...
     * @return the ServerInstanceDetailResponse object itself.
     */
    public ServerInstanceDetailResponse withServerInstanceList(List<ServerInstanceList> serverInstanceList) {
