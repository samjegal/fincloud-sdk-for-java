...
/**
 * The ServerInstanceListResponse model.
 */
public class ServerInstanceListResponse {
     ...
     * @return the ServerInstanceListResponse object itself.
     */
    public ServerInstanceListResponse withReturnCode(String returnCode) {
     ...
     * @return the ServerInstanceListResponse object itself.
     */
    public ServerInstanceListResponse withReturnMessage(String returnMessage) {
     ...
     * @return the ServerInstanceListResponse object itself.
     */
    public ServerInstanceListResponse withTotalRows(Integer totalRows) {
     ...
     * @return the ServerInstanceListResponse object itself.
     */
    public ServerInstanceListResponse withServerInstanceList(List<ServerInstanceList> serverInstanceList) {
