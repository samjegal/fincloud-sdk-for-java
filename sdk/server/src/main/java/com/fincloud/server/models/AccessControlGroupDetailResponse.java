...
/**
 * The AccessControlGroupDetailResponse model.
 */
public class AccessControlGroupDetailResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the AccessControlGroupDetailResponse object itself.
     */
    public AccessControlGroupDetailResponse withReturnCode(String returnCode) {
     ...
     * @return the AccessControlGroupDetailResponse object itself.
     */
    public AccessControlGroupDetailResponse withReturnMessage(String returnMessage) {
     ...
     * @return the AccessControlGroupDetailResponse object itself.
     */
    public AccessControlGroupDetailResponse withTotalRows(Integer totalRows) {
     ...
     * @return the AccessControlGroupDetailResponse object itself.
     */
    public AccessControlGroupDetailResponse withAccessControlGroupList(List<AccessControlGroupList> accessControlGroupList) {
