...
/**
 * The NetworkInterfaceListResponse model.
 */
public class NetworkInterfaceListResponse {
     ...
     * @return the NetworkInterfaceListResponse object itself.
     */
    public NetworkInterfaceListResponse withReturnCode(String returnCode) {
     ...
     * @return the NetworkInterfaceListResponse object itself.
     */
    public NetworkInterfaceListResponse withReturnMessage(String returnMessage) {
     ...
     * @return the NetworkInterfaceListResponse object itself.
     */
    public NetworkInterfaceListResponse withTotalRows(Integer totalRows) {
     ...
     * @return the NetworkInterfaceListResponse object itself.
     */
    public NetworkInterfaceListResponse withNetworkInterfaceList(List<NetworkInterfaceList> networkInterfaceList) {
