...
/**
 * The PublicIpWithServerInstanceResponse model.
 */
public class PublicIpWithServerInstanceResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the PublicIpWithServerInstanceResponse object itself.
     */
    public PublicIpWithServerInstanceResponse withReturnCode(String returnCode) {
     ...
     * @return the PublicIpWithServerInstanceResponse object itself.
     */
    public PublicIpWithServerInstanceResponse withReturnMessage(String returnMessage) {
     ...
     * @return the PublicIpWithServerInstanceResponse object itself.
     */
    public PublicIpWithServerInstanceResponse withTotalRows(Integer totalRows) {
     ...
     * @return the PublicIpWithServerInstanceResponse object itself.
     */
    public PublicIpWithServerInstanceResponse withPublicIpInstanceList(List<PublicIpInstanceList> publicIpInstanceList) {
