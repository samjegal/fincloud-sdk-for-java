...
/**
 * The PublicIpInstanceResponse model.
 */
public class PublicIpInstanceResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the PublicIpInstanceResponse object itself.
     */
    public PublicIpInstanceResponse withReturnCode(String returnCode) {
     ...
     * @return the PublicIpInstanceResponse object itself.
     */
    public PublicIpInstanceResponse withReturnMessage(String returnMessage) {
     ...
     * @return the PublicIpInstanceResponse object itself.
     */
    public PublicIpInstanceResponse withTotalRows(Integer totalRows) {
     ...
     * @return the PublicIpInstanceResponse object itself.
     */
    public PublicIpInstanceResponse withPublicIpInstanceList(List<PublicIpInstanceList> publicIpInstanceList) {
