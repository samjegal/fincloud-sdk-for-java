...
public class PublicIpFromServerInstanceResponse {
     ...
     * @return the PublicIpFromServerInstanceResponse object itself.
     */
    public PublicIpFromServerInstanceResponse withReturnCode(String returnCode) {
     ...
     * @return the PublicIpFromServerInstanceResponse object itself.
     */
    public PublicIpFromServerInstanceResponse withReturnMessage(String returnMessage) {
     ...
     * @return the PublicIpFromServerInstanceResponse object itself.
     */
    public PublicIpFromServerInstanceResponse withTotalRows(Integer totalRows) {
     ...
     * @return the PublicIpFromServerInstanceResponse object itself.
     */
    public PublicIpFromServerInstanceResponse withPublicIpInstanceList(List<PublicIpInstanceList> publicIpInstanceList) {
