...
/**
 * The NetworkInterfaceAccessControlGroupResponse model.
 */
public class NetworkInterfaceAccessControlGroupResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the NetworkInterfaceAccessControlGroupResponse object itself.
     */
    public NetworkInterfaceAccessControlGroupResponse withReturnCode(String returnCode) {
     ...
     * @return the NetworkInterfaceAccessControlGroupResponse object itself.
     */
    public NetworkInterfaceAccessControlGroupResponse withReturnMessage(String returnMessage) {
     ...
     * @return the NetworkInterfaceAccessControlGroupResponse object itself.
     */
    public NetworkInterfaceAccessControlGroupResponse withTotalRows(Integer totalRows) {
     ...
     * @return the NetworkInterfaceAccessControlGroupResponse object itself.
     */
    public NetworkInterfaceAccessControlGroupResponse withNetworkInterfaceList(List<NetworkInterfaceList> networkInterfaceList) {
