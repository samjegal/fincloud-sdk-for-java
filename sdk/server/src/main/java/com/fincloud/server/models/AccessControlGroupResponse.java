...
/**
 * The AccessControlGroupResponse model.
 */
public class AccessControlGroupResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the AccessControlGroupResponse object itself.
     */
    public AccessControlGroupResponse withReturnCode(String returnCode) {
     ...
     * @return the AccessControlGroupResponse object itself.
     */
    public AccessControlGroupResponse withReturnMessage(String returnMessage) {
     ...
     * @return the AccessControlGroupResponse object itself.
     */
    public AccessControlGroupResponse withTotalRows(Integer totalRows) {
     ...
     * @return the AccessControlGroupResponse object itself.
     */
    public AccessControlGroupResponse withAccessControlGroupList(List<AccessControlGroupList> accessControlGroupList) {
