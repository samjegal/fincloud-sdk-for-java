...
/**
 * The PlacementGroupListResponse model.
 */
public class PlacementGroupListResponse {
     ...
     * @return the PlacementGroupListResponse object itself.
     */
    public PlacementGroupListResponse withReturnCode(String returnCode) {
     ...
     * @return the PlacementGroupListResponse object itself.
     */
    public PlacementGroupListResponse withReturnMessage(String returnMessage) {
     ...
     * @return the PlacementGroupListResponse object itself.
     */
    public PlacementGroupListResponse withTotalRows(Integer totalRows) {
     ...
     * @return the PlacementGroupListResponse object itself.
     */
    public PlacementGroupListResponse withPlacementGroupList(List<PlacementGroupList> placementGroupList) {
