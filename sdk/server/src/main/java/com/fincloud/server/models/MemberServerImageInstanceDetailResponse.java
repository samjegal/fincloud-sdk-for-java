...
/**
 * The MemberServerImageInstanceDetailResponse model.
 */
public class MemberServerImageInstanceDetailResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the MemberServerImageInstanceDetailResponse object itself.
     */
    public MemberServerImageInstanceDetailResponse withReturnCode(String returnCode) {
     ...
     * @return the MemberServerImageInstanceDetailResponse object itself.
     */
    public MemberServerImageInstanceDetailResponse withReturnMessage(String returnMessage) {
     ...
     * @return the MemberServerImageInstanceDetailResponse object itself.
     */
    public MemberServerImageInstanceDetailResponse withTotalRows(Integer totalRows) {
     ...
     * @return the MemberServerImageInstanceDetailResponse object itself.
     */
    public MemberServerImageInstanceDetailResponse withMemberServerImageInstanceList(List<MemberServerImageInstanceList> memberServerImageInstanceList) {
