...
/**
 * The PlacementGroupResponse model.
 */
public class PlacementGroupResponse {
     ...
     * @return the PlacementGroupResponse object itself.
     */
    public PlacementGroupResponse withReturnCode(String returnCode) {
     ...
     * @return the PlacementGroupResponse object itself.
     */
    public PlacementGroupResponse withReturnMessage(String returnMessage) {
     ...
     * @return the PlacementGroupResponse object itself.
     */
    public PlacementGroupResponse withTotalRows(Integer totalRows) {
     ...
     * @return the PlacementGroupResponse object itself.
     */
    public PlacementGroupResponse withPlacementGroupList(List<PlacementGroupList> placementGroupList) {
