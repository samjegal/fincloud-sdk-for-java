...
/**
 * The ServerImageProductListResponse model.
 */
public class ServerImageProductListResponse {
     ...
     * @return the ServerImageProductListResponse object itself.
     */
    public ServerImageProductListResponse withReturnCode(String returnCode) {
     ...
     * @return the ServerImageProductListResponse object itself.
     */
    public ServerImageProductListResponse withReturnMessage(String returnMessage) {
     ...
     * @return the ServerImageProductListResponse object itself.
     */
    public ServerImageProductListResponse withTotalRows(Integer totalRows) {
     ...
     * @return the ServerImageProductListResponse object itself.
     */
    public ServerImageProductListResponse withProductList(List<ProductList> productList) {
