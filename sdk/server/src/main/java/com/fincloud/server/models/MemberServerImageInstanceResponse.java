...
/**
 * The MemberServerImageInstanceResponse model.
 */
public class MemberServerImageInstanceResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the MemberServerImageInstanceResponse object itself.
     */
    public MemberServerImageInstanceResponse withReturnCode(String returnCode) {
     ...
     * @return the MemberServerImageInstanceResponse object itself.
     */
    public MemberServerImageInstanceResponse withReturnMessage(String returnMessage) {
     ...
     * @return the MemberServerImageInstanceResponse object itself.
     */
    public MemberServerImageInstanceResponse withTotalRows(Integer totalRows) {
     ...
     * @return the MemberServerImageInstanceResponse object itself.
     */
    public MemberServerImageInstanceResponse withMemberServerImageInstanceList(List<MemberServerImageInstanceList> memberServerImageInstanceList) {
