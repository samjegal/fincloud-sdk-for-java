...
/**
 * The NetworkInterfaceResponse model.
 */
public class NetworkInterfaceResponse {
     ...
     * @return the NetworkInterfaceResponse object itself.
     */
    public NetworkInterfaceResponse withReturnCode(String returnCode) {
     ...
     * @return the NetworkInterfaceResponse object itself.
     */
    public NetworkInterfaceResponse withReturnMessage(String returnMessage) {
     ...
     * @return the NetworkInterfaceResponse object itself.
     */
    public NetworkInterfaceResponse withTotalRows(Integer totalRows) {
     ...
     * @return the NetworkInterfaceResponse object itself.
     */
    public NetworkInterfaceResponse withNetworkInterfaceList(List<NetworkInterfaceList> networkInterfaceList) {
