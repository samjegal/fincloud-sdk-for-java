...
/**
 * The ServerInstanceSpecResponse model.
 */
public class ServerInstanceSpecResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the ServerInstanceSpecResponse object itself.
     */
    public ServerInstanceSpecResponse withReturnCode(String returnCode) {
     ...
     * @return the ServerInstanceSpecResponse object itself.
     */
    public ServerInstanceSpecResponse withReturnMessage(String returnMessage) {
     ...
     * @return the ServerInstanceSpecResponse object itself.
     */
    public ServerInstanceSpecResponse withTotalRows(Integer totalRows) {
     ...
     * @return the ServerInstanceSpecResponse object itself.
     */
    public ServerInstanceSpecResponse withServerInstanceList(List<ServerInstanceList> serverInstanceList) {
