...
/**
 * The BlockStorageInstanceListResponse model.
 */
public class BlockStorageInstanceListResponse {
     ...
     * @return the BlockStorageInstanceListResponse object itself.
     */
    public BlockStorageInstanceListResponse withReturnCode(String returnCode) {
     ...
     * @return the BlockStorageInstanceListResponse object itself.
     */
    public BlockStorageInstanceListResponse withReturnMessage(String returnMessage) {
     ...
     * @return the BlockStorageInstanceListResponse object itself.
     */
    public BlockStorageInstanceListResponse withTotalRows(Integer totalRows) {
     ...
     * @return the BlockStorageInstanceListResponse object itself.
     */
    public BlockStorageInstanceListResponse withBlockStorageInstanceList(List<BlockStorageInstanceList> blockStorageInstanceList) {
