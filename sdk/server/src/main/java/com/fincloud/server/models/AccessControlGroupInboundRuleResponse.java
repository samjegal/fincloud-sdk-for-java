...
/**
 * The AccessControlGroupInboundRuleResponse model.
 */
public class AccessControlGroupInboundRuleResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the AccessControlGroupInboundRuleResponse object itself.
     */
    public AccessControlGroupInboundRuleResponse withReturnCode(String returnCode) {
     ...
     * @return the AccessControlGroupInboundRuleResponse object itself.
     */
    public AccessControlGroupInboundRuleResponse withReturnMessage(String returnMessage) {
     ...
     * @return the AccessControlGroupInboundRuleResponse object itself.
     */
    public AccessControlGroupInboundRuleResponse withTotalRows(Integer totalRows) {
     ...
     * @return the AccessControlGroupInboundRuleResponse object itself.
     */
    public AccessControlGroupInboundRuleResponse withAccessControlGroupRuleList(List<AccessControlGroupRuleList> accessControlGroupRuleList) {
