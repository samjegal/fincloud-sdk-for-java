...
/**
 * The AccessControlGroupRuleListResponse model.
 */
public class AccessControlGroupRuleListResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the AccessControlGroupRuleListResponse object itself.
     */
    public AccessControlGroupRuleListResponse withReturnCode(String returnCode) {
     ...
     * @return the AccessControlGroupRuleListResponse object itself.
     */
    public AccessControlGroupRuleListResponse withReturnMessage(String returnMessage) {
     ...
     * @return the AccessControlGroupRuleListResponse object itself.
     */
    public AccessControlGroupRuleListResponse withTotalRows(Integer totalRows) {
     ...
     * @return the AccessControlGroupRuleListResponse object itself.
     */
    public AccessControlGroupRuleListResponse withAccessControlGroupRuleList(List<AccessControlGroupRuleList> accessControlGroupRuleList) {
