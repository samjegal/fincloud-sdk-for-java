...
public class LoginKeyResponse {
     ...
     * @return the LoginKeyResponse object itself.
     */
    public LoginKeyResponse withReturnCode(String returnCode) {
     ...
     * @return the LoginKeyResponse object itself.
     */
    public LoginKeyResponse withReturnMessage(String returnMessage) {
     ...
     * @return the LoginKeyResponse object itself.
     */
    public LoginKeyResponse withTotalRows(Integer totalRows) {
     ...
     * @return the LoginKeyResponse object itself.
     */
    public LoginKeyResponse withLoginKeyList(List<LoginKeyList> loginKeyList) {
