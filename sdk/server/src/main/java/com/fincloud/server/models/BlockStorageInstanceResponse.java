...
/**
 * The BlockStorageInstanceResponse model.
 */
public class BlockStorageInstanceResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the BlockStorageInstanceResponse object itself.
     */
    public BlockStorageInstanceResponse withReturnCode(String returnCode) {
     ...
     * @return the BlockStorageInstanceResponse object itself.
     */
    public BlockStorageInstanceResponse withReturnMessage(String returnMessage) {
     ...
     * @return the BlockStorageInstanceResponse object itself.
     */
    public BlockStorageInstanceResponse withTotalRows(Integer totalRows) {
     ...
     * @return the BlockStorageInstanceResponse object itself.
     */
    public BlockStorageInstanceResponse withBlockStorageInstanceList(List<BlockStorageInstanceList> blockStorageInstanceList) {
