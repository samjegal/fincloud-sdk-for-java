...
/**
 * The PublicIpInstanceDetailResponse model.
 */
public class PublicIpInstanceDetailResponse {
    /**
     * 리턴 코드.
     */
     ...
     * @return the PublicIpInstanceDetailResponse object itself.
     */
    public PublicIpInstanceDetailResponse withReturnCode(String returnCode) {
     ...
     * @return the PublicIpInstanceDetailResponse object itself.
     */
    public PublicIpInstanceDetailResponse withReturnMessage(String returnMessage) {
     ...
     * @return the PublicIpInstanceDetailResponse object itself.
     */
    public PublicIpInstanceDetailResponse withTotalRows(Integer totalRows) {
     ...
     * @return the PublicIpInstanceDetailResponse object itself.
     */
    public PublicIpInstanceDetailResponse withPublicIpInstanceList(List<PublicIpInstanceList> publicIpInstanceList) {
